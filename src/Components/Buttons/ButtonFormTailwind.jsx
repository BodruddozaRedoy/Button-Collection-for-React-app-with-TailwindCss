const ButtonSample3 = () => {
    return (
      <div className="flex flex-col items-center min-h-screen py-5 justify-center gap-9 bg-gray-300">
        ...
        <div>
        <div class='button w-40 h-16 bg-red-500 rounded-lg cursor-pointer select-none
          active:translate-y-2  active:[box-shadow:0_0px_0_0_#cb1c00]
          active:border-b-[0px]
          transition-all duration-150 [box-shadow:0_10px_0_0_#cb1c00]
